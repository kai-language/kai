...
class DirectiveIf: Node, TopLevelStmt {
    var keyword: Pos
    var cond: Expr
    var body: Stmt
    var els: Stmt?
    ...
    // NOTE: generated by checker
    var nodeToCodegen: Stmt?

// sourcery:inline:auto:DirectiveIf.Init
init(keyword: Pos, cond: Expr, body: Stmt, els: Stmt?, nodeToCodegen: Stmt?) {
    self.keyword = keyword
    self.cond = cond
    self.body = body
    self.els = els
    self.nodeToCodegen = nodeToCodegen
}
// sourcery:end
}
